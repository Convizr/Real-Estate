      ...
      function startBookingProcess() {
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 600px; margin: 20px auto;">
            ...
            <div id="dateSelector" style="display: flex; gap: 5px; justify-content: space-around; margin-bottom: 15px;"></div>
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="nextButton" style="height: 50px; width: 100px; font-size: 14px; border-radius: 8px; background-color: #007BFF; color: white; padding: 10px; border: none; cursor: pointer; transition: background 0.2s;">Next</button>
            </div>
          </div>
        `;
        // Month navigation and date/time generation.
        ...
        // Set currentWeekStart as the first upcoming date.
        ...
        function renderDateButtons() {
          ...
          weekDates.forEach(d => {
            ...
            // Always add a small horizontal margin.
        ...
        // Time slots: ensure selection persists.
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 600px; margin: 20px auto;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="personalNext" style="height: 50px; width: 100px; border-radius: 8px; background: #007BFF; color: white; padding: 10px; border: none; font-size: 14px; cursor: pointer; transition: background 0.2s;">Next</button>
            </div>
          </div>
        `;
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 600px; margin: 20px auto; font-size: 14px;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="confirmBtn" style="height: 50px; border-radius: 8px; background: #007BFF; color: white; padding: 10px; border: none; font-size: 16px; cursor: pointer; transition: background 0.2s;">Confirm</button>
            </div>
          </div>
        `;
