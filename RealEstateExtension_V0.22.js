export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      function showPropertyDetail(property) {
        ...
        // On hover, adjust the svg icon and background circle.
        ...
        // Trigger the appointment scheduler on click.
      ...
      // with Personal Information Step and Confirmation
      // -----------------------------------------------
      function startBookingProcess() {
        ...
        // "Back" returns to the grid view.
        backButton.addEventListener("click", () => {
          renderGrid();
        });
  
        // "Next" moves to the Personal Information step if a date and time are selected.
        nextButton.addEventListener("click", () => {
          if (selectedDate && selectedTime) {
            renderPersonalInfoStep(selectedDate, selectedTime);
          } else {
      ...
      // -----------------------------------------------
      function renderPersonalInfoStep(selectedDate, selectedTime) {
        container.innerHTML = '';
        container.style.display = 'block';
        ...
        container.innerHTML = `
          <div class="personal-info-container" style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.15); text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div class="info-fields" style="text-align: left; margin-bottom: 20px;">
            ...
            <div class="nav-buttons" style="display: flex; justify-content: space-between;">
              <button id="personalBack" style="padding: 10px; border: none; border-radius: 8px; background-color: #007BFF; color: white; cursor: pointer; font-size: 16px; transition: background 0.2s;">Back</button>
              <button id="personalNext" style="padding: 10px; border: none; border-radius: 8px; background-color: #007BFF; color: white; cursor: pointer; font-size: 16px; transition: background 0.2s;">Next</button>
            </div>
          </div>
        `;
        ...
        personalNext.addEventListener('click', () => {
          ...
          // Proceed to the confirmation view.
          renderConfirmationView(selectedDate, selectedTime, name, email, phone);
        });
      }
      ...
      // Confirmation View
      // -----------------------------------------------
      function renderConfirmationView(selectedDate, selectedTime, name, email, phone) {
        container.innerHTML = '';
        container.style.display = 'block';
        ...
        container.innerHTML = `
          <div class="confirmation-container" style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.15); text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div class="overview" style="text-align: left; margin-bottom: 20px;">
            ...
            <div class="nav-buttons" style="display: flex; justify-content: space-between;">
              <button id="confirmBack" style="padding: 10px; border: none; border-radius: 8px; background-color: #007BFF; color: white; cursor: pointer; font-size: 16px; transition: background 0.2s;">Back</button>
              <button id="confirmBtn" style="padding: 10px; border: none; border-radius: 8px; background-color: #007BFF; color: white; cursor: pointer; font-size: 16px; transition: background 0.2s;">Confirm Viewing</button>
            </div>
          </div>
        `;
