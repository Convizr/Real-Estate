// ================================================
// CONFIGURATION OBJECT (for colors, fonts, sizes, etc.)
// ================================================
const config = {
    containerWidth: "600px",
    gridColumns: 3,
    fontFamily: "soleto, sans-serif",
    gridTitleFontSize: "13px",
    headingFontSize: "20px",
    subHeadingFontSize: "18px",
    personalLabelFontSize: "12px",
    primaryColor: "#007BFF",
    primaryColorHover: "#0056b3",
    secondaryColor: "#51bce6",
    textColor: "black",
    errorColor: "red",
    backgroundColor: "#FFFFFF",
    buttonHeight: "50px",
    bookViewingButtonWidth: "150px",
    contactButtonWidth: "100px",
    nextButtonWidth: "80px",
    confirmButtonWidth: "100px",
  };
  
  // ================================================
  // REAL ESTATE EXTENSION CODE
  // ================================================
  export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      // New: availability data (an array of objects)
      let availabilityData = payloadObj.availability || [];
      // Global variable to store viewing duration (e.g. 3600 seconds for 1h)
      let viewingDuration = 0;
      ...
      let personalEmail = "";
      let personalPhone = "";
      let selectedDateStr = ""; // in YYYY-MM-DD
      ...
      function renderGrid() {
        ...
        properties.forEach((property) => {
          ...
          title.style.fontSize = config.gridTitleFontSize;
      ...
      function startBookingProcess() {
        ...
        // In this updated version we now use the availabilityData instead of a default constant.
        const defaultTimeSlots = []; // not used directly
        ...
        // UPDATED: Use availabilityData to get time slots for the selected property on the selected date.
        ...
        function updateTimeSlots(dateStr) {
          ...
          let availableTimes = [];
          // Loop through availabilityData to find a record for this property on the selected date.
      ...
      function renderConfirmationView() {
        ...
        confirmBtn.addEventListener('click', () => {
          ...
          const payload = {
            ...
            duration: viewingDuration, // added viewing duration from availability data
          };
