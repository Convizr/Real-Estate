    ...
    render: ({ trace, element }) => {
      ...
      function renderGrid() {
        ...
        properties.forEach((property) => {
          ...
          title.style.fontSize = '13px'; // reduced font size for titles
      ...
      function startBookingProcess() {
        container.innerHTML = '';
        container.style.display = 'block';
        // Integrated appointment view with consistent width.
        container.innerHTML = `
      ...
      function renderPersonalInfoStep() {
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; display: flex; flex-direction: column; align-items: center; text-align: center; max-width: 600px; margin: 20px auto;">
      ...
      function renderConfirmationView() {
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; display: flex; flex-direction: column; align-items: center; text-align: center; max-width: 600px; margin: 20px auto; font-size: 14px;">
            <h2 style="margin-bottom: 10px; font-size: 18px;">Confirm Your Viewing</h2>
            <div style="text-align: center; width: 100%; max-width: 400px; margin-bottom: 20px;">
              <p><strong>Property:</strong> ${selectedPropertyName}</p>
            ...
            <div id="confirmError" style="margin-bottom: 10px; text-align: center; color: red; font-size: 12px;"></div>
            <div style="margin-bottom: 20px; text-align: center; font-size: 12px; width: 100%; max-width: 400px;">
        ...
        confirmBtn.addEventListener('click', () => {
          ...
          // --- Prepare and send payload back to Voiceflow ---
          const payload = {
            propertyName: selectedPropertyName,
            salesRep: repName,
            salesRepNumber: repNumber,
            salesRepEmail: repEmail,
            appointmentDate: formatDate(appointmentDate), // now in DD-MM-YYYY
          ...
          // Send payload back to Voiceflow.
          ...
          container.innerHTML = `
            <div style="background: #d4edda; padding: 20px; display: flex; flex-direction: column; align-items: center; text-align: center; max-width: 600px; margin: 20px auto; color: #155724; font-size: 14px;">
