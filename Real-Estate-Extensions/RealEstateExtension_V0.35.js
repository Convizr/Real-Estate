export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      let repEmail = "";
      let repImage = "";
      let currentProperty = null; // store current property object
      let appointmentDate = "";
      let appointmentTime = "";
      let personalName = "";
      let personalEmail = "";
      ...
      // Main container – set a consistent max-width.
      const container = document.createElement('div');
      container.style.maxWidth = '450px';
      container.style.margin = '20px auto';
      container.style.fontFamily = 'soleto, sans-serif';
      // (Other container styles for spacing remain as before.)
      ...
      function showPropertyDetail(property) {
        ...
        // Details section: show all property info in two columns.
      ...
      function startBookingProcess() {
        container.innerHTML = '';
        container.style.display = 'block';
        // Integrated look: same width, no extra drop-shadow.
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="nextButton" style="height: 50px; width: 250px; font-size: 14px; border-radius: 8px; background: #007BFF; color: white; padding: 10px; border: none; cursor: pointer; transition: background 0.2s;">Next</button>
            </div>
          </div>
        `;
        ...
        // Back button: hover changes only text color.
        backButton.addEventListener('mouseover', () => { backButton.style.color = '#007BFF'; });
        backButton.addEventListener('mouseout', () => { backButton.style.color = 'black'; });
        ...
        // Maintain currentWeekStart based on the first upcoming date.
        ...
        function renderDateButtons() {
          ...
          // Filter upcomingDates for dates within the week starting currentWeekStart.
          const weekDates = upcomingDates.filter(d => d >= currentWeekStart && d < new Date(currentWeekStart.getTime() + 7 * 86400000));
          // If no dates are available in the week, clear the timeslots.
        ...
        prevWeek.addEventListener('click', () => {
          ...
          updateMonthLabel();
          renderDateButtons();
          timeSlotsContainer.innerHTML = ""; // Clear timeslots if no date selected.
        });
        nextWeek.addEventListener('click', () => {
          currentWeekStart.setDate(currentWeekStart.getDate() + 7);
          updateMonthLabel();
          renderDateButtons();
          timeSlotsContainer.innerHTML = ""; // Clear timeslots.
        });
        ...
        function updateTimeSlots(dateStr) {
          timeSlotsContainer.innerHTML = "";
          // If no times available for the date, clear.
          if (!dateStr) return;
        ...
        backButton.addEventListener("click", () => {
          // Back from appointment view returns to property view.
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="personalNext" style="height: 50px; width: 250px; border-radius: 8px; background: #007BFF; color: white; padding: 10px; border: none; font-size: 14px; cursor: pointer; transition: background 0.2s;">Next</button>
            </div>
          </div>
        `;
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="confirmBtn" style="height: 50px; border-radius: 8px; background: #007BFF; color: white; padding: 10px; border: none; font-size: 16px; cursor: pointer; transition: background 0.2s;">Confirm Viewing</button>
            </div>
          </div>
        `;
