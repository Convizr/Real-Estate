export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      function showPropertyDetail(property) {
        ...
        // "Book a Viewing" button (width 150px).
      ...
      function startBookingProcess() {
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 600px; margin: 20px auto;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <button id="nextButton" style="height: 40px; width: 80px; font-size: 14px; border-radius: 8px; background-color: #007BFF; color: white; padding: 10px; border: none; cursor: pointer; transition: background 0.2s;">Next</button>
            </div>
          </div>
        `;
        ...
        function renderDateButtons() {
          ...
          weekDates.forEach(d => {
            ...
            dayButton.style.margin = "0 5px"; // maintain gap always
