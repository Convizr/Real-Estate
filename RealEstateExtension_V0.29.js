export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      function showPropertyDetail(property) {
        ...
        // Align items so that both top and bottom align.
        imageRow.style.alignItems = 'stretch';
        imageRow.style.marginBottom = '15px';
        imageRow.style.height = '400px'; // Fixed row height
  
        // Left column: Main image (smaller than before)
        const mainImageContainer = document.createElement('div');
        mainImageContainer.style.flex = '2';
        mainImageContainer.style.maxWidth = '60%';
        // Make the main image container a bit smaller in height.
        ...
        // Align thumbnails so that the top of the first and bottom of the last align.
        ...
        // --- Book a Viewing Button (Styled as per your snippet) ---
        // We'll create an anchor element with the desired styles.
        ...
        // Append the icon span after the anchor's text.
        bookViewingLink.appendChild(iconSpan);
        // Hover effects.
        bookViewingLink.addEventListener('mouseover', () => {
          bookViewingLink.style.width = '200px';
          bookViewingLink.style.border = '3px solid #2ecc71';
          bookViewingLink.style.background = 'transparent';
          bookViewingLink.style.color = '#2ecc71';
          iconSpan.style.border = '3px solid #2ecc71';
          iconSpan.style.right = '-25%';
        });
        bookViewingLink.addEventListener('mouseout', () => {
          bookViewingLink.style.width = '250px';
          bookViewingLink.style.border = '3px solid #333';
          bookViewingLink.style.background = '#333';
          bookViewingLink.style.color = '#fff';
          iconSpan.style.border = '3px solid transparent';
          iconSpan.style.right = '0';
        });
        // On click, proceed to appointment scheduler.
