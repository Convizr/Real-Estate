export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      let repEmail = "";
      let repImage = "";
      let currentProperty = null; // current property object
      let appointmentDate = "";
      let appointmentTime = "";
      let personalName = "";
      let personalEmail = "";
      ...
      // Utility: simple hover effect for background (not for text-only hovers).
      ...
      function showPropertyDetail(property) {
        ...
        imageRow.style.height = '300px'; // Row height equals main image container
      ...
      function startBookingProcess() {
        container.innerHTML = '';
        container.style.display = 'block';
        // Integrated view: no extra drop shadow.
        container.innerHTML = `
        ...
        // Back button: only text color changes.
        backButton.addEventListener('mouseover', () => { backButton.style.color = '#007BFF'; });
        backButton.addEventListener('mouseout', () => { backButton.style.color = 'black'; });
        ...
        function renderDateButtons() {
          ...
          // Filter upcomingDates for current week (7 days).
      ...
      function renderPersonalInfoStep() {
        ...
        // For text-only hover effect, add custom listeners.
