export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      // Remove background from parent if present.
      ...
      function showPropertyDetail(property) {
        ...
        // --- Updated Image Row ---
        // The image row's overall height is set to match the main image container.
        ...
        // Right column: Thumbnails (aligned top and bottom)
        ...
        // Details section – display all property info in two columns.
        ...
        // --- Book a Viewing Button (Solid blue → outline on hover) ---
        ...
        // --- Contact Button (Outline → solid on hover) ---
      ...
      function startBookingProcess() {
        container.innerHTML = '';
        container.style.display = 'block';
        // Remove drop shadow and border-radius so it looks integrated.
        container.innerHTML = `
        ...
        `;
        // Remove extra drop shadow and border-radius from the container above.
        ...
        // Set month header & week navigation:
        ...
        // Use the availableDates as a source; assume the first available date is our start.
        ...
        // We'll maintain a "currentWeekStart" date (as a Date object). For this demo, use the earliest available date.
        let currentWeekStart = new Date(availableDates[0]);
        // Prevent going to past weeks relative to currentWeekStart.
        ...
        function renderDateButtons() {
          ...
          // Create buttons for 7 days starting at currentWeekStart.
          for (let i = 0; i < 7; i++) {
            ...
            dayButton.style.fontWeight = "bold"; // Bold the date numbers.
        ...
        prevWeek.addEventListener('click', () => {
          ...
          // Only allow moving back if the new week would not be entirely in the past.
        ...
        function updateTimeSlots(dateStr) {
          ...
          if (availableTimeSlots[dateStr]) {
            availableTimeSlots[dateStr].forEach(time => {
        ...
        nextButton.addEventListener("click", () => {
          if (selectedTimeSlot) {
            appointmentDate = dateSelector.children[0].textContent.split('\n')[1] // simple demo; ideally store full date
              ? new Date(currentWeekStart).toISOString().slice(0, 10) : "";
      ...
      function renderConfirmationView() {
        ...
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div id="confirmError" style="margin-bottom: 10px; text-align: left; color: red;"></div>
