export const RealEstateExtension = {
  ...
  render: ({ trace, element }) => {
    ...
    function showPropertyDetail(property) {
      ...
      // Book a Viewing Button with modern styling
      ...
      // Contact Button with modern styling
    ...
    // Update all other text elements to use Soleto
    ...
    // Apply font update after rendering each view
