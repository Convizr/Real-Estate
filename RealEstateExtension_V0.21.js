export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      // with Personal Information Step
      // -----------------------------------------------
      ...
      function renderPersonalInfoStep(selectedDate, selectedTime) {
        ...
        // Create the personal information view.
        container.innerHTML = `
          <div class="personal-info-container" style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.15); text-align: center; max-width: 450px; margin: 20px auto;">
            ...
            <div class="nav-buttons" style="display: flex; justify-content: space-between;">
              <button id="personalBack" style="padding: 10px; border: none; border-radius: 8px; background-color: #007BFF; color: white; cursor: pointer; font-size: 16px;">Back</button>
              <button id="personalNext" style="padding: 10px; border: none; border-radius: 8px; background-color: #007BFF; color: white; cursor: pointer; font-size: 16px;">Next</button>
            </div>
          </div>
        `;
  
        // Attach event listeners to the personal info buttons.
        const personalBack = container.querySelector('#personalBack');
        const personalNext = container.querySelector('#personalNext');
  
        // When clicking Back, return to the appointment scheduler view.
        personalBack.addEventListener('click', () => {
          startBookingProcess();
        });
  
        // On Next, you might proceed to confirmation or further steps.
        personalNext.addEventListener('click', () => {
          // For demonstration, we'll simply log the entered information.
          ...
          // Here you could proceed to a confirmation step or finalize the booking.
          alert(`Appointment scheduled on ${selectedDate} at ${selectedTime}\nName: ${name}\nEmail: ${email}\nPhone: ${phone}`);
        });
      }
