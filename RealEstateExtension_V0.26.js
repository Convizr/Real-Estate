export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      function showPropertyDetail(property) {
        ...
        imageRow.style.alignItems = 'flex-start'; // Changed from 'stretch'
        ...
        // --- Book a Viewing Button with Updated Styling ---
        ...
        // --- Contact Button with Updated Styling ---
        ...
        contactButton.addEventListener('mouseover', () => {
          contactButton.style.backgroundColor = 'rgba(0, 123, 255, 0.1)';
        });
        ...
        // --- Back to Listings Button with Updated Styling ---
      ...
      // Utility to update font family on all children.
      const updateFontFamily = (element) => {
        if (element.style) {
          element.style.fontFamily = 'soleto, sans-serif';
        }
        Array.from(element.children).forEach(updateFontFamily);
      };
      const originalRenderGrid = renderGrid;
      renderGrid = () => {
        originalRenderGrid();
        updateFontFamily(container);
      };
