export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      // Booking breadcrumb globals (if you choose to use the canvas breadcrumb below).
      const bookingSteps = ["Property", "Appointment", "Personal Info", "Confirmation"];
      let visitedSteps = [true, false, false, false];
      ...
      // Helper to send the outgoing payload.
      ...
      // --- Wrapper for consistent sub–view width (600px) and centering ---
      ...
      function renderGrid() {
        ...
        properties.forEach((property) => {
          ...
          propertyCard.addEventListener('click', () => {
            ...
            // (Optionally clear any breadcrumb here.)
      ...
      function showPropertyDetail(property) {
        ...
        bookViewingLink.addEventListener('click', () => {
          // When booking starts, reset booking flow globals.
      ...
      function startBookingProcess() {
        container.innerHTML = '';
        container.style.display = 'block';
        // (Optional: Render breadcrumb canvas here if desired)
        container.innerHTML = `
      ...
      function renderPersonalInfoStep() {
        container.innerHTML = '';
        container.style.display = 'block';
        // Centered by max-width and auto margin.
        container.innerHTML = `
          <div style="background: white; padding: 20px; text-align: center; max-width: 600px; margin: 20px auto;">
