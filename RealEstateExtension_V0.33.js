export const RealEstateExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      let repEmail = "";
      let repImage = "";
      let currentProperty = null; // store the current property object
      let appointmentDate = "";
      let appointmentTime = "";
      let personalName = "";
      let personalEmail = "";
      ...
      // Utility function to add a simple hover effect.
      ...
      function renderGrid() {
        ...
        properties.forEach((property) => {
          ...
          propertyCard.addEventListener('click', () => {
            ...
            currentProperty = property; // store current property
      ...
      function showPropertyDetail(property) {
        ...
        // --- Image Row Styling ---
        // The image row’s height is set to 300px (matching the main image container).
        ...
        // Right column: Thumbnails – align so that the top and bottom match the main image.
        ...
        // Details section – now in two columns.
        ...
        // In property view, back button goes to grid.
      ...
      function startBookingProcess() {
        container.innerHTML = '';
        container.style.display = 'block';
        // Appointment view without extra drop shadow; integrated look.
        container.innerHTML = `
        ...
        `;
        // Set up month/week navigation and generate upcoming 10 days.
        ...
        addHoverEffect(backButton, 'transparent', '#007BFF');
        addHoverEffect(nextButton, '#007BFF', '#0056b3');
  
        // Generate upcoming 10 days from today.
        const upcomingDates = [];
        ...
        // Default timeslots for each day.
        const defaultTimeSlots = ["09:00", "10:00", "11:00", "13:00", "14:00", "15:00", "16:00"];
  
        // We'll maintain a "currentWeekStart" (Date object) based on the first date in upcomingDates.
        ...
        function renderDateButtons() {
          ...
          // Filter upcomingDates to only show dates starting from currentWeekStart and for the next 7 days.
        ...
        prevWeek.addEventListener('click', () => {
          ...
          // Prevent going to past if newWeekStart is before today.
        ...
        // Time slots generation using defaultTimeSlots.
        let selectedTimeSlot = "";
        function updateTimeSlots(dateStr) {
          timeSlotsContainer.innerHTML = "";
          // For demo purposes, we assume every date gets the defaultTimeSlots.
        ...
        backButton.addEventListener("click", () => {
          // Back from appointment view goes back to the property view.
          showPropertyDetail(currentProperty);
        });
  
        nextButton.addEventListener("click", () => {
          if (selectedTimeSlot) {
            // Use the selected date from the first date button as a demo.
