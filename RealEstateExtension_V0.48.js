...
const config = {
    ...
    // Colors
    primaryColor: "#007BFF",         // Main blue for buttons etc.
    primaryColorHover: "#0056b3",      // Hover for primary color
    secondaryColor: "#51bce6",         // For WhatsApp button background
    textColor: "black",
    errorColor: "red",
    backgroundColor: "#FFFFFF",        // For white backgrounds
    ...
    // Breadcrumb canvas settings
    canvas: {
      width: 600,
      height: 80,
      backgroundGradient: "linear-gradient(to right, #5A46E3, #4A37D2)",
    ...
    render: ({ trace, element }) => {
      ...
      function renderConfirmationView() {
        ...
        confirmBtn.addEventListener('click', () => {
          ...
          // --- Prepare payload to send back to Voiceflow ---
          const payload = {
